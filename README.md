...
## Updated News
- [2022-05-14] According to our experiments in self-supervised representation learning, we found that SYSU-30k can check the quality of SSL algorithms. The code for training SSL can be found at [here](https://github.com/wanggrun/triplet). The code to test SSL is close to the test code in this project.
