...
parser.add_argument('--image_folder', action='store_true', help='dataset is in form of image folder')
...
parser.add_argument("--bagid", type=int, default=1, help='the number of id for per bag')
