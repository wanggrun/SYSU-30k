...
class MGN(nn.Module):
    def __init__(self, args):
        ...
        self.maxpool_low_level_feat = pool2d(kernel_size=(96, 32))
    ...
    def forward(self, x):
        ...
        low_level_feat = self.maxpool_low_level_feat(x)
        low_level_feat = low_level_feat.view(-1, 256)
        ...
        return predict, fg_p1, fg_p2, fg_p3, l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3, low_level_feat
